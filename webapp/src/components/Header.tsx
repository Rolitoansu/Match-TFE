...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-black/10 bg-white/95 shadow-[0_14px_32px_-24px_rgba(15,23,42,0.45)] backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 px-4 py-3 md:grid md:grid-cols-[1fr_auto_1fr] md:items-center md:gap-6 md:px-6 md:py-4">
        <button
          type="button"
        ...
        <div className="relative flex items-center justify-end gap-2 self-center md:self-auto" ref={notificationPanelRef}>
          <label className="relative">
            ...
            <select
              ...
              className="h-11 w-28 rounded-full border border-black/5 bg-slate-100/85 pl-9 pr-8 text-xs font-bold uppercase tracking-[0.08em] text-slate-600 transition-colors hover:bg-white focus:outline-none focus:ring-2 focus:ring-primary/30 md:w-auto"
              aria-label="Language"
            >
          ...
          {isNotificationsOpen && (
            <div className="absolute right-0 top-14 z-40 w-[calc(100vw-2rem)] max-w-sm rounded-2xl border border-black/10 bg-white p-3 shadow-xl shadow-slate-300/60 md:w-80">
